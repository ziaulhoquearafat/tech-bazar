...
// const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.6prdapd.mongodb.net/?appName=Cluster0`;

// app.get("/", (req, res) => {
//   res.send("Tech Bazar is Running");
// });
...
// app.listen(port, () => {
//   console.log(`Tech Bazar is Running on the port: ${port}`);
// });
